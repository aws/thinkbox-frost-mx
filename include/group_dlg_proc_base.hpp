        ...
        try {
            ...
            case WM_COMMAND:
                ...
                case IDC_ADD: {
                    ...
                    show_edit_particle_groups_dialog( ghInstance, GetCOREInterface()->GetMAXHWnd(),
                ...
                case IDC_OPTIONS:
                    ...
                    frantic::max3d::mxs::expression( frantic::tstring() + _T("if (FrostUi!=undefined) do (FrostUi.") +
                                                     group_dlg_proc_traits::get_mxs_options_callback() +
                                                     _T(" frostNode)") )
                ...
                break;
            case WM_CONTEXTMENU:
                if( handle_listbox_contextmenu( GetDlgItem( hwnd, IDC_LIST ), lParam ) ) {
                    update_control_enable( hwnd );
                    notify_if_missing_frost_mxs();
                    frantic::max3d::mxs::expression( frantic::tstring() + _T("if (FrostUi!=undefined) do (FrostUi.") +
                                                     group_dlg_proc_traits::get_mxs_right_click_callback() +
                                                     _T(" frostNode)") )
                        .bind( _T("frostNode"), m_obj )
                        .at_time( t )
                        .evaluate<void>();
