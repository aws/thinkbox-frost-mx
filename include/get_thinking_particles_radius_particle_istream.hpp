...
class get_thinking_particles_radius_particle_istream : public frantic::particles::streams::delegated_particle_istream {
  ...
  public:
    get_thinking_particles_radius_particle_istream(
    ...
    virtual ~get_thinking_particles_radius_particle_istream() {}
