...
class simple_object_accessor_base {
  ...
  protected:
    ...
    inline simple_object_accessor_base( SimpleObject2* owner, const ParamID paramID )
        : m_owner( owner )
        , m_paramID( paramID ) {}
...
class simple_object_accessor : public simple_object_accessor_base {
  ...
  public:
    simple_object_accessor( SimpleObject2* owner, const ParamID paramID );
...
template <class T>
simple_object_accessor<T>::simple_object_accessor( SimpleObject2* owner, const ParamID paramID )
...
class simple_object_accessor<T>::helper {
  private:
    ...
    friend class simple_object_accessor::tab_helper;
