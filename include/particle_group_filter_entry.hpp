...
class particle_group_filter_entry {
  ...
  public:
    ...
    virtual void add_to_frost( Frost& frost ) = 0;
...
class thinking_particles_group_filter_entry : public particle_group_filter_entry {
  ...
  public:
    ...
    void add_to_frost( Frost& frost ) { frost.add_tp_group( m_node, m_group ); }
};
...
class particle_flow_group_filter_entry : public particle_group_filter_entry {
  ...
  public:
    ...
    void add_to_frost( Frost& frost ) { frost.add_particle_flow_event( m_node ); }
};
