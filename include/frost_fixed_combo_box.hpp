...
class frost_fixed_combo_box {
    ...
    frost_fixed_combo_box& operator=( const frost_fixed_combo_box& );

  public:
    frost_fixed_combo_box( HWND hwnd, int id, const std::vector<int>& ( *getDisplayCodes )(),
